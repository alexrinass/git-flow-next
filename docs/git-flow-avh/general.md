# git flow - General Commands

This is an overview of general commands that work as shortcuts for the currently checked out branch.
...
**Example:**
If you are on a feature branch named `New1`, `git flow finish -S` will do the same as `git flow feature finish -S New1`
...
**Example:**
If you are on a feature branch named `New1`, `git flow delete -r` will do the same as `git flow feature delete -r New1`
...
**Example:**
If you are on a feature branch named `New1`, `git flow publish` will do the same as `git flow feature publish New1`
...
**Example:**
If you are on a feature branch named `New1`, `git flow rebase -p` will do the same as `git flow feature rebase -p New1`